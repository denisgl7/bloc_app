...
import 'package:bloc_cocktails_app/app/core/src/model/cocktail_definition.dart';
...
class CocktailsState extends Union4Impl<CocktailsInitial, CocktailsLoadInProgress, CocktailsLoadSuccess, CocktailsLoadFailure> {
  static const unions = Quartet<CocktailsInitial, CocktailsLoadInProgress, CocktailsLoadSuccess, CocktailsLoadFailure>();
